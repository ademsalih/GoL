...
public class DynamicGIF {
    ...
    public List<List<Byte>> gifBoard;
    public DynamicBoard importedDynamicBoard;
    ...
    private void copyImportedBoardToGIFBoard() {
        ...
        System.out.println("done copying over values...");
    ...
    public void drawFrame() {
        ...
        gwriter.fillRect(0,1400-1,0,1000-1,backgroundColor);
    ...
    public void next() {
        ...
        gifBoard = gifDynamicRule.conwaysBoardRules();
    }
